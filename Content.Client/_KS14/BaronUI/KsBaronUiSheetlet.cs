...
public sealed class KsBaronUiSheetlet : Sheetlet<PalettedStylesheet>
{
    ...
    {
        var regularFont = ResCache.GetFont("/Fonts/NotoSans/NotoSansSymbols-Regular.ttf", 12); // inky - changed from /Fonts/_KS14/BaronUI/FontStack-Regular.TTF
        var boldFont = ResCache.GetFont("/Fonts/NotoSans/NotoSansSymbols-Bold.ttf", 12);
        var regularFontSmall = ResCache.GetFont("/Fonts/NotoSans/NotoSansSymbols-Regular.ttf", 10);
        var regularFontLarge = ResCache.GetFont("/Fonts/NotoSans/NotoSansSymbols-Regular.ttf", 14);
        var boldFontLarge = ResCache.GetFont("/Fonts/NotoSans/NotoSansSymbols-Bold.ttf", 16);
        var boldFontLarger = ResCache.GetFont("/Fonts/NotoSans/NotoSansSymbols-Bold.ttf", 20);
