...
public sealed partial class EnergyReagentDispenserSystem : EntitySystem
{
    ...
    private static float GetPowerCostForReagent(string reagentId, FixedPoint2 /* inky edit */ amount, EnergyReagentDispenserComponent comp)
        => comp.Reagents.TryGetValue(reagentId, out var cost)
            ? cost * amount.Float() // inky edit
            : 0f;
